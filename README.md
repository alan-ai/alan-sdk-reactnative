...
To add voice to a React Native app:
...
2. Use the Alan React Native SDK to embed the Alan button to your app. For details, see <a href="https://alan.app/docs/client-api/cross-platform/react-native" target="_blank">Alan AI documentation</a>.
